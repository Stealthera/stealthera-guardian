    ...
    <section id="problem" className="py-20 px-4 relative">
      ...
      <div className="max-w-6xl mx-auto z-10 relative">
        <h2 className="text-center mb-12 text-white">
          Why Eldercare Feels Like a <span className="text-stealth-purple">Race Against Time</span>
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
          {problemData.map((problem, index) => (
            <div 
              key={index} 
              className="bg-stealth-black border border-stealth-indigo/20 rounded-lg p-8 transition-all duration-300 
