  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center px-4 py-20 relative overflow-hidden">
      ...
      <div className="z-10 max-w-4xl mx-auto text-center animate-fade-in">
        ...
        <h2 className="mb-10 text-base md:text-lg text-[#CCCCCC] font-inter max-w-2xl mx-auto font-light">
          AI-powered wearable that keeps seniors safe, connected, and monitored—anytime, anywhere.
        </h2>
        
        <div className="flex flex-col sm:flex-row justify-center gap-4 mb-16">
          <Button 
            className="bg-stealth-blue hover:bg-stealth-purple text-white transition-all hover:scale-105 hover:shadow-[0_0_15px_rgba(86,204,242,0.5)]" 
          ...
          <Button 
            variant="ghost" 
            className="text-[#F0F0F0] hover:text-stealth-blue group flex items-center gap-2 transition-all"
          >
